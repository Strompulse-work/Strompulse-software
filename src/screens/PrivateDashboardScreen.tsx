...
const styles = StyleSheet.create({
  ...
  backButtonText: { fontSize: 13, fontFamily: "Chirp-Bold", color: "#FFFFFF", marginLeft: 4 },
  ...
  title: { fontSize: 26, fontFamily: "Chirp-Heavy", marginBottom: 10 },
  subtitle: { fontSize: 13, fontFamily: "Chirp-Regular", textAlign: "center", lineHeight: 22, marginBottom: 36, paddingHorizontal: 10 },
  ...
  unlockBtnText: { color: "#FFFFFF", fontSize: 15, fontFamily: "Chirp-Bold" },
  demoText: { fontSize: 11, fontFamily: "Chirp-Medium", color: "#64748B" },
  ...
  secondaryTitle: { fontSize: 15, fontFamily: "Chirp-Bold", marginBottom: 6 },
  secondarySubtitle: { fontSize: 11, fontFamily: "Chirp-Regular", lineHeight: 18, marginBottom: 14 },
  requestLinkRow: { flexDirection: "row", alignItems: "center" },
  requestLinkText: { fontSize: 12, fontFamily: "Chirp-Bold", color: "#00C48A", marginRight: 4 },
});
